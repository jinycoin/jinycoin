...
// Dash
// JINY TODO: previously defined in net_processing.h, Bitcoin Core removed from .h but needed for Dash
        ...
        // JINY END
        {
          ...
          if (inv.type == MSG_TX || inv.type == MSG_WITNESS_TX) {
            ...
            // Dash
            {
                ...
                // JINY TODO: check if there are MSG_TX messages in Dash processing before removing this code
                /*
...
bool static ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, int64_t nTimeReceived, const CChainParams& chainparams, CConnman* connman, const std::atomic<bool>& interruptMsgProc, bool enable_bip61)
{
    ...
    else if (strCommand == NetMsgType::TX)
    {
        ...
        // JINY TODO: // remove after implementation
        CTxLockRequest txLockRequest;
