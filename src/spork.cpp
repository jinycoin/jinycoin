...
void CSporkManager::LoadSporksFromDB()
{
    ...
    for (int i = SPORK_START; i <= SPORK_JINY_END; ++i) {
        if (i > SPORK_END && i < SPORK_JINY_START) i = SPORK_JINY_START;
    // JINY END
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            // JINY BEGIN
            case SPORK_JINY_01_HANDBRAKE_HEIGHT :           r = SPORK_JINY_01_HANDBRAKE_HEIGHT_DEFAULT; break;
            case SPORK_JINY_01_HANDBRAKE_FORCE_X16R:        r = SPORK_JINY_01_HANDBRAKE_FORCE_X16R_DEFAULT; break;

            case SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     r = SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT; break;
            case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK:         r = SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT; break;
            case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE:         r = SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT; break;
            case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE:      r = SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT; break;
            case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE:      r = SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT; break;

            case SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START:   r = SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START_DEFAULT; break;
            // JINY END
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        // JINY BEGIN
        case SPORK_JINY_01_HANDBRAKE_HEIGHT:            return SPORK_JINY_01_HANDBRAKE_HEIGHT_DEFAULT;
        case SPORK_JINY_01_HANDBRAKE_FORCE_X16R:        return SPORK_JINY_01_HANDBRAKE_FORCE_X16R_DEFAULT;

        case SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE_DEFAULT;
        case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK:         return SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK_DEFAULT;
        case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE:         return SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE_DEFAULT;
        case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE:      return SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE_DEFAULT;
        case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE_DEFAULT;

        case SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START:   return SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START_DEFAULT;
        // JINY END
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    // JINY BEGIN
    if (strName == "SPORK_JINY_01_HANDBRAKE_HEIGHT")            return SPORK_JINY_01_HANDBRAKE_HEIGHT;
    if (strName == "SPORK_JINY_01_HANDBRAKE_FORCE_X16R")        return SPORK_JINY_01_HANDBRAKE_FORCE_X16R;

    if (strName == "SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE")     return SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE;
    if (strName == "SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK")         return SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK;
    if (strName == "SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE")         return SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE;
    if (strName == "SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE")      return SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE;
    if (strName == "SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE")      return SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE;

    if (strName == "SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START")   return SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START;
    // JINY END
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        // JINY BEGIN
        case SPORK_JINY_01_HANDBRAKE_HEIGHT:            return "SPORK_JINY_01_HANDBRAKE_HEIGHT";
        case SPORK_JINY_01_HANDBRAKE_FORCE_X16R:        return "SPORK_JINY_01_HANDBRAKE_FORCE_X16R";

        case SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE:     return "SPORK_JINY_02_IGNORE_SLIGHTLY_HIGHER_COINBASE";
        case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK:         return "SPORK_JINY_02_IGNORE_FOUNDER_REWARD_CHECK";
        case SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE:         return "SPORK_JINY_02_IGNORE_FOUNDER_REWARD_VALUE";
        case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE:      return "SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_VALUE";
        case SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE:      return "SPORK_JINY_02_IGNORE_MASTERNODE_REWARD_PAYEE";

        case SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START:   return "SPORK_JINY_03_BLOCK_REWARD_SMOOTH_HALVING_START";
        // JINY END
        default:
