...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    // Dash
    // JINY TODO: privatesend and instantsend checkbox must be added to GUI! next two rows are just temporary placeholder!
    ...
    // JINY TODO: Obsolete check, remove later
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid JinyCoin address"));
        }
        else // Valid address
        {
