...
#ifndef JINY_UI_INTERFACE_H
#define JINY_UI_INTERFACE_H
...
public:
    ...
    // JINY TODO: boost::signals2::signal<void (int newNumMasternodes)> NotifyStrMasternodeCountChanged; 
    ...
    // JINY TODO: boost::signals2::signal<void (std::function<void(void)> action)> SetProgressBreakAction; 
